#Exp:-701:- Write a python program to implement GUI Application using Tkinter.
'''
           Name:- Saqlain Kalokhe
           RollNo:- 20CO22
           Academic Year :- 2021-22

THEORY: Python offers multiple options for developing GUI (Graphical User Interface). Out of all the GUI methods, tkinter is the most commonly used method. 
        It is a standard Python interface to the Tk GUI toolkit shipped with Python. Python with tkinter is the fastest and easiest way to create the 
...
me.geometry("354x460")
me.title("CALCULATOR")
melabel = Label(me, text="CALCULATOR", bg='Black', font=("Times", 30, 'bold'))
...
metext = Entry(me, font=("Black", 12, 'bold'), textvar=textin, width=25, bd=5, bg='Black')
metext.pack()
...
butequal = Button(me, padx=151, pady=14, bd=4, bg='white', command=equlbut, text="=", font=("Black", 16, 'bold'))
butequal.place(x=10, y=380)
me.mainloop()


'''
Conclusion: We have successfully implemented GUI Application using Tkinter to make a simple calculator
'''